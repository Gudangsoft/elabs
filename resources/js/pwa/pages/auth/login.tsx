        ...
        <AuthLayout title="Log in to your account" description="Enter your email and password below to log in">
            ...
            <form className="flex flex-col gap-6 text-gray-800" onSubmit={submit}>
                <div className="grid gap-6">
                    ...
                    <div className="grid gap-2">
                        <div className="flex items-center">
                            ...
                            {canResetPassword && (
                                <TextLink href={route('password.request')} className="ml-auto text-sm text-teal-600" tabIndex={5}>
                                    Forgot password?
                                </TextLink>
                            )}
                        </div>
                ...
                <div className="text-center text-sm text-muted-foreground">
                    ...
                    <TextLink href={route('register')} tabIndex={5} className="underline text-teal-600 font-bold">
                        Sign up
                    </TextLink>
                </div>
